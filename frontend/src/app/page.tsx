    ...
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex flex-col px-6 md:px-12 pb-12 max-w-3xl">
          ...
          >
            Trade large<br />blocks without<br />moving the<br />market.
          </h1>

          {/* 3 metrics — staggered after title */}
          <div className="flex gap-8 sm:gap-12">
            {[
              { value: "60s", label: "Batch Cycle" },
              { value: "100%", label: "Sealed" },
              { value: "0", label: "Front-runs" },
            ].map((stat, i) => (
              <div
                key={i}
                style={{
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 p-8 min-h-[200px] flex flex-col justify-between relative overflow-hidden" delay={0}>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-light mb-3">Sealed Limit Orders</h3>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={120}>
              ...
              <h3 className="text-lg font-light mb-2">Batch Auctions</h3>
              <p className="text-sm text-black/45 leading-relaxed">Every 60 seconds all crossing orders settle together at a single uniform clearing price.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={160}>
              ...
              <h3 className="text-lg font-light mb-2">On-chain Escrow</h3>
              <p className="text-sm text-black/45 leading-relaxed">Funds lock in a Soroban vault. Settlement pays the matched amount and refunds the rest atomically.</p>
            </BentoCard>

            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={200}>
              <div className="w-10 h-10 rounded-xl border border-black/10 flex items-center justify-center mb-5">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 2 4 6v6c0 5 8 8 8 8s8-3 8-8V6z"/><path d="m9 12 2 2 4-4"/></svg>
              </div>
              <h3 className="text-lg font-light mb-2">Zero-Knowledge Proofs</h3>
              <p className="text-sm text-black/45 leading-relaxed">Groth16 over BN254 proves your order is valid without revealing its price or size.</p>
            </BentoCard>
          </div>
        </div>
      </section>

      {/* ── ORDER LIFECYCLE (4 cards) ─────────────────────────────────────── */}
      <section id="agents" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              <PixelIcon type="agents" size={40} />
              <div className="mt-4"><Tag>ORDER LIFECYCLE</Tag></div>
      ...
      <section id="workflow" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              { n: "01", title: "Commit",  desc: "Lock your price and size into a commitment. A Groth16 proof seals it — the network sees nothing.", delay: 0,   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/define-5aafAmGBrxZpOqJ3XLHY3n3qzC2I5K.png" },
              { n: "02", title: "Batch",   desc: "Your order joins the 60-second batch alongside every other sealed order in the pool.", delay: 80,  img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/compose-5RT5VR4f1Y3GoFmovqTKLTG4UXp3g2.png" },
              { n: "03", title: "Match",   desc: "The matching engine crosses bids and asks at a single uniform clearing price.", delay: 140, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/test-zm8guZwxJHtwWsJ7XO4B0CF7GzlNK8.png" },
              { n: "04", title: "Settle",  desc: "Escrow releases the matched amount on Stellar and refunds the remainder atomically.", delay: 200, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/deploy-an8fgHSLzniojkcmRyGGIFQUJF9T5J.png" },
            ].map((step) => (
          ...
          <div className="rounded-2xl overflow-hidden border border-black/[0.07] flex flex-col md:block md:relative" onMouseMove={handleMouse}>
            ...
            <div className="relative w-full h-[280px] md:h-[480px] shrink-0">
              <img
                ...
                alt="Dark pool settlement architecture"
            ...
            <div className="flex flex-col gap-3 p-4 md:absolute md:bottom-4 md:right-4 md:p-0 md:w-72">
              ...
              >
                ...
                <div className="bg-black/[0.05] rounded-lg border border-black/[0.07] p-3 font-mono text-[11px] text-black/50 leading-relaxed">
                  ...
                  {"  "}<span className="text-amber-700/70">size</span>: <span className="text-black/35">500</span><br />
                  {"})"}
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-black/40 tracking-widest">ON STELLAR</span>
                </div>
                <p className="text-sm text-black/45">Every trade settles on Stellar Soroban. Non-custodial escrow, atomic release and refund.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  { label: "Groth16 Proofs", desc: "Each order sealed with a zero-knowledge validity proof" },
                  { label: "On-chain Settlement", desc: "Every fill recorded and settled on Stellar Soroban" },
                  { label: "Uniform Clearing", desc: "One fair price per batch — no price-time advantage" },
                ].map((item) => (
              ...
              <div className="pt-4 flex flex-col gap-2">
                {["Groth16 / BN254", "Stellar Soroban", "Non-custodial", "Open Source"].map((badge) => (
            ...
            {/* Right side — live settlement log visualization */}
            <BentoCard className="p-6 lg:row-span-1" delay={0}>
              <div className="text-xs text-black/30 tracking-widest uppercase mb-4">Live Settlement Trail</div>
              <div className="space-y-2">
                {[
                  { time: "12:34:21", action: "order_sealed", status: "success" },
                  { time: "12:34:18", action: "batch_opened", status: "success" },
                  { time: "12:34:15", action: "order_matched", status: "success" },
                  { time: "12:34:12", action: "escrow_released", status: "success" },
                  { time: "12:34:09", action: "trade_settled", status: "success" },
                ].map((log, i) => (
                  <div
                    key={i}
      ...
      <section className="py-0 border-t border-black/[0.06] overflow-hidden select-none">
        <div className="flex border-b border-black/[0.06]" style={{ animation: "marqueeLeft 28s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Sealed Orders", "Batch Auction", "Uniform Price", "Groth16 Proof", "Zero Front-running", "On-chain Escrow", "Atomic Settlement", "Non-custodial", "XLM / USDC", "Dark Pool"].map((cap) => (
        ...
        <div className="flex" style={{ animation: "marqueeRight 22s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Stellar Soroban", "BN254 Curve", "Commitment Scheme", "Clearing Price", "No Slippage", "No Market Impact", "Institutional Blocks", "60-Second Cycle", "Verifiable Fills", "Front-run Proof"].map((cap) => (
                <div key={cap} className="flex items-center gap-6 px-10 py-5 border-r border-black/[0.06] shrink-0">
      ...
      <section id="live" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <PixelIcon type="agents" size={40} />
              <div className="mt-4"><Tag>LIVE BATCH</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.05]">
                {"Orders clearing\nevery 60 seconds."}
              </RevealText>
              ...
              <div className="mt-10 flex items-end gap-2">
                <LiveAgentCounter />
                <span className="text-black/30 text-sm mb-1 tracking-wide">XLM cleared this session</span>
              </div>
            </div>
      ...
      <footer className="py-10 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <span className="font-pixel text-xs tracking-[0.25em] text-black/50">AETHER</span>

          {/* Nav sections */}
          <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
            {[
              { label: "Protocol",  href: "#platform" },
              { label: "Lifecycle", href: "#agents" },
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-black/[0.04]">
          <span className="text-xs text-black/20">© 2026 Aether. All rights reserved.</span>
        </div>
      </footer>
    </div>
  )
