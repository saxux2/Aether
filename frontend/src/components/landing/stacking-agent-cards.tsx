...
const AGENTS = [
  {
    ...
    desc: "Your price and size are hashed into a commitment and sealed with a Groth16 proof. The network can verify the order is valid without ever seeing it.",
    stats: [{ v: "Groth16", l: "proof system" }, { v: "0", l: "info leaked" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/researcher-CvhqOuV6irGwBOnJoTGFlXdbyYBRjb.png",
  },
  {
    label: "SUBMIT",
    title: "Enter the batch",
    desc: "Sealed orders flow through the relayer into the on-chain order book and join the current 60-second auction window — invisible to everyone else.",
    stats: [{ v: "60s", l: "batch window" }, { v: "100%", l: "sealed" }],
  ...
  },
  {
    ...
    desc: "When the window closes, the matching engine crosses every bid and ask and computes a single clearing price. No price-time priority, no front-running.",
    stats: [{ v: "1", l: "clearing price" }, { v: "fair", l: "for all fills" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/analyst-Ysxnqg7Fpy2cfA56PiIttv1KximMhT.png",
  },
  {
    label: "SETTLE",
    title: "Atomic settlement",
    desc: "Escrow releases the matched amount to the counterparty and refunds any surplus to you — in one atomic Soroban transaction on Stellar. Fully non-custodial.",
    stats: [{ v: "Stellar", l: "settlement layer" }, { v: "atomic", l: "release + refund" }],
